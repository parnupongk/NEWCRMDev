(function(namespace, $) {
    ...
    var DemoFormComponents = function() {
        ...
        $(document).ready(function() {
            ...
            $("#nc_new").click(function() {
                $("#nc1").hide();
                $("#nc2").slideDown();
            });

            $("#nc_closed").click(function() {
                $("#nc2").fadeOut(200, function(){
                  $("#nc1").fadeIn(200);    
                });
                                
            });

            $("#btn_last_criteria").click(function() {
                $("#last_criteria").slideDown();
            });

            $("#btn_last_criteria_x").click(function() {
                $("#last_criteria").slideUp();
            });
        });
...
//		});
    ...
    p._initSliders = function() {
        ...
        $("#slider-step").slider({value: 3, min: 1, max: 5, step: 1,
            slide: function(event, ui) {
    ...
    p._initDatePicker = function() {
        ...
        $('#casedate').datepicker({autoclose: true, todayHighlight: true, format: "dd/mm/yyyy"});
