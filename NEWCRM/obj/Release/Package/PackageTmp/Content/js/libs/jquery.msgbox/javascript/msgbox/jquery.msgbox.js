        ...
        this.esqueleto.msgbox.queue(this.options.name, $.proxy(function( next ) {
          ...
          if (options.type != 'prompt')
          {
            $.each(buttons, $.proxy(function(i, button) {
                if (button.type == 'submit')   //<button type="button" class="btn btn-block ink-reaction btn-primary-bright">Primary</button>
              {
                    // this.esqueleto.buttons.append($('<button type="submit">'+button.value+'</button>').bind('click', $.proxy(function(e) { this.close(button.value); e.preventDefault(); }, this))); <button type="button" class="btn btn-block ink-reaction btn-default-light">Default</button>
                    this.esqueleto.buttons.append($('<button type="button" class="btn ink-reaction btn-primary">' + button.value + '</button>').bind('click', $.proxy(function (e) { this.close(button.value); e.preventDefault(); }, this)));
              }
              else if (button.type == 'cancel')
              {
                  ...
                  this.esqueleto.buttons.append($('<button type="button" class="btn ink-reaction btn-primary">' + button.value + '</button>').bind('click', $.proxy(function (e) { this.close(false); e.preventDefault(); }, this)));
              }
            }, this));
          }
          else if (options.type == 'prompt')
          {
            $.each(buttons, $.proxy(function(i, button) {
              ...
              {
                  this.esqueleto.buttons.append($('<button type="button" class="btn ink-reaction btn-primary">' + button.value + '</button>').bind('click', $.proxy(function (e) {
